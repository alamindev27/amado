...
@yield('products')
        ...
        {{-- <div class="products-catagories-area clearfix">
            <div class="amado-pro-catagory clearfix">
                ...
                <div class="single-products-catagory clearfix">
                    <a href="shop.html">
                        <img src="{{ asset('frontend') }}/img/bg-img/3.jpg" alt="">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>From $180</p>
                ...
                <div class="single-products-catagory clearfix">
                    <a href="shop.html">
                        <img src="{{ asset('frontend') }}/img/bg-img/4.jpg" alt="">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>From $180</p>
                ...
                <div class="single-products-catagory clearfix">
                    <a href="shop.html">
                        <img src="{{ asset('frontend') }}/img/bg-img/8.jpg" alt="">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>From $318</p>
                ...
                <div class="single-products-catagory clearfix">
                    <a href="shop.html">
                        <img src="{{ asset('frontend') }}/img/bg-img/9.jpg" alt="">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>From $318</p>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="{{ url('/') }}"><img src="{{ asset('frontend') }}/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
